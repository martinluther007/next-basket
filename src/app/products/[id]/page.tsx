    ...
    <>
      ...
      <section className="py-10 hidden sm:block px-20 xl:px-60">
        <div className="flex border-b pb-10 justify-center items-center w-full">
          <button className="text-secondaryTextColor capitalize text-sm font-bold">
            Description
          </button>
          <button className="text-secondaryTextColor ml-7 capitalize text-sm font-bold">
            Additional Information
          </button>
          <button className="text-secondaryTextColor ml-7 capitalize text-sm font-bold">
            Reviews
            <span className="text-secondary ml-3">(0)</span>
          </button>
        </div>
      </section>
      <section className="py-10 hidden sm:block px-20 xl:px-60">
        <div className="flex justify-between">
          <div className=" w-[450px] mr-5">
            <h2 className="font-bold text-xl text-textColor">
              the quick fox jumps over
            </h2>
            <p className="text-xs mt-6 text-secondaryTextColor">
              Met minim Mollie non desert Alamo est sit cliquey dolor do met
              sent. RELIT official consequent door ENIM RELIT Mollie. Excitation
              venial consequent sent nostrum met.
            </p>

            <p className="text-xs text-secondaryTextColor pl-10 border-l-2 mt-6 border-secondary">
              Met minim Mollie non desert Alamo est sit cliquey dolor do met
              sent. RELIT official consequent door ENIM RELIT Mollie. Excitation
              venial consequent sent nostrum met.
            </p>

            <p className="text-xs text-secondaryTextColor  mt-6 ">
              Met minim Mollie non desert Alamo est sit cliquey dolor do met
              sent. RELIT official consequent door ENIM RELIT Mollie. Excitation
              venial consequent sent nostrum met.
            </p>
          ...
          <div>
            <Image src={quick} alt="product detail " />
          </div>
        </div>
      </section>
      ...
      <section className="bg-[#FAFAFA] py-10 px-5 md:px-20 lg:px-28 xl:px-72">
        <div className="flex flex-col sm:flex-row justify-between items-center">
          {sponsorsData.map((ele, index) => (
            <div className="mt-8 mr-2 sm:mt-0" key={index}>
              {ele.component}
            </div>
          ))}
        </div>
